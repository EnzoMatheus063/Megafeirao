// nesse arquivo, definimos as rotas relacionadas aos frete e associamos cada rota a uma função do FreteController. As rotas são:
...
const ClienteController = require("../controller/Frete_controller.js");

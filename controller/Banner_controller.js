...
function cadastrar(req, res) {
    ...
    Banner_model.buscarPorimagem(banner.imagem, (erro, resultado) => {
        ...
        Banner_model.cadastrar(banner, (erro, resultado) => {
...
function listar(req, res) {
    ...
    Banner_model.listar((erro, resultado) => {
...
function buscarPorId(req, res) {
    ...
    Banner_model.buscarPorId(id, (erro, resultado) => {
...
function atualizar(req, res) {
    ...
    Banner_model.atualizar(id, banner, (erro, resultado) => {
...
function excluir(req, res) {
    ...
    Banner_model.excluir(id, (erro, resultado) => {

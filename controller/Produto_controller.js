...
const Produto_model = require("../model/Produto_model");
...
function cadastrar(req, res) {
    ...
    Produto_model.buscarPorCodigo(produto.codigo, (erro, resultado) => {
        ...
        Produto_model.cadastrar(produto, (erro, resultado) => {
...
function listar(req, res) {
    ...
    Produto_model.listar((erro, resultado) => {
...
function buscarPorId(req, res) {
    ...
    Produto_model.buscarPorId(id, (erro, resultado) => {
...
function atualizar(req, res) {
    ...
    Produto_model.atualizar(id, produto, (erro, resultado) => {
...
function excluir(req, res) {
    ...
    Produto_model.excluir(id, (erro, resultado) => {

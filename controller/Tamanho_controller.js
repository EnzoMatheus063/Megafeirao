...
const Tamanho_model = require("../model/Tamanho_model");
...
function cadastrar(req, res) {
    ...
    if (!tamanho.Loja_idLoja) {

        tamanho.Loja_idLoja = 1;

    }

    // Verifica se já existe um usuário com o mesmo e-mail

    Tamanho_model.buscarPorNome(tamanho.tamanho, (erro, resultado) => {
        ...
        Tamanho_model.cadastrar(tamanho, (erro, resultado) => {
...
function listar(req, res) {
    ...
    Tamanho_model.listar((erro, resultado) => {
...
function buscarPorId(req, res) {
    ...
    Tamanho_model.buscarPorId(id, (erro, resultado) => {
...
function atualizar(req, res) {
    ...
    Tamanho_model.atualizar(id, tamanho, (erro, resultado) => {
...
function excluir(req, res) {
    ...
    Tamanho_model.excluir(id, (erro, resultado) => {
